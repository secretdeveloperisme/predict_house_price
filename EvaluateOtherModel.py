...
fieldnames = ['Loop', 'LinearRegression','LinearRegressionLibrary', 'Ridge', 'Lasso', 'ElasticNet', 'BayesianRidge']
...
for i in range(10):
    ...
    mse_csv.writerow({
        ...
        "LinearRegressionLibrary": linear_lib_mse,
        "Ridge": ridge_mse,
        "Lasso": lasso_mse,
    ...
    score_csv.writerow({
        ...
        "LinearRegressionLibrary": round(linear_lib_score*100, 3),
